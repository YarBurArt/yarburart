...
=========================
Developer on python / C# and Security Specialist
------------------------------------------------
In the coding world, I build web services, scripts, and bots using Python, C, C#, Java, and a bit of JavaScript. I also do Linux administration and create automation scripts in Bash. I am currently researching cybersecurity to have peace of mind about my code and servers.
